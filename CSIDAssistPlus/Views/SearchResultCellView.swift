...
//    @StateObject var viewModel: HomeScreenViewModel
    ...
    var body: some View {
        ...
        if #available(iOS 18.0, *) {
            ZStack {
                NavigationLink(destination: CA_AddNewMealScreen().navigationBarBackButtonHidden(true).navigationTransition(.zoom(sourceID: "cell", in: namespace))) {EmptyView()}.opacity(0.0)
